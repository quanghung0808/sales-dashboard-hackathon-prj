...
export default function PublicLandingPage() {
  ...
  const featureCards = [
    ...
    {
      icon: Award,
      title: 'Sales Performance & Commission',
    ...
    <div className="space-y-24 pb-20 animate-in fade-in duration-300">
      ...
      <section id="home" className="relative pt-12 md:pt-20 text-center space-y-8 max-w-5xl mx-auto px-4">
        ...
        <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/10 border border-indigo-500/30 px-4 py-1.5 text-xs font-bold text-indigo-400">
          <Sparkles className="h-4 w-4 animate-spin text-indigo-400" /> Commercial SaaS Platform for Enterprise Sales
        </div>
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 via-indigo-500 to-rose-500 bg-clip-text text-transparent leading-tight">
          AI Sales Copilot for Modern Businesses
        </h1>

        <p className="text-base md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl mx-auto">
          Connect your CRM, ERP or eCommerce platform in minutes. Automatically generate AI summaries, sales insights, KPI tracking and customer timelines without changing your existing workflow.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          ...
          <Link href="/docs">
            <Button variant="outline" size="lg" className="h-12 px-8 text-base font-semibold border-slate-300 dark:border-slate-700">
              <Code2 className="h-5 w-5 mr-2 text-indigo-500" /> View API Documentation
            </Button>
          </Link>
        </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 space-y-12">
        <div className="text-center space-y-3">
          <Badge variant="default" className="text-xs font-bold uppercase tracking-wider">Features Matrix</Badge>
      ...
      <section id="solutions" className="max-w-7xl mx-auto px-4 space-y-12">
        <div className="text-center space-y-3">
          <Badge variant="warning" className="text-xs font-bold uppercase tracking-wider">Solutions by Industry</Badge>
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">
      ...
      <section id="pricing" className="max-w-7xl mx-auto px-4 space-y-12">
        <div className="text-center space-y-3">
          <Badge variant="danger" className="text-xs font-bold uppercase tracking-wider">Pricing Plans</Badge>
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="relative overflow-hidden">
            <CardHeader className="space-y-2">
              ...
              <p className="text-xs text-slate-400">Cho doanh nghiệp vừa & nhỏ</p>
            </CardHeader>
            <CardContent className="space-y-4 text-xs">
              <ul className="space-y-2">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> 1 Công Ty Tenant</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Tối đa 15 Sales Reps</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> 50,000 API Requests/tháng</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> AI Conversation Summary</li>
              </ul>
          ...
          <Card className="relative overflow-hidden border-2 border-indigo-500 shadow-xl">
            ...
            <CardHeader className="space-y-2">
              ...
              <p className="text-xs text-slate-400">Cho chuỗi thương hiệu & showroom lớn</p>
            </CardHeader>
            <CardContent className="space-y-4 text-xs">
              <ul className="space-y-2">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Multi-Tenant (Không giới hạn)</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Tối đa 100 Sales Reps</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> 500,000 API Requests/tháng</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Daily 18:00 AI Summary & Webhooks</li>
              </ul>
              <Link href="/login" className="block pt-2">
                <Button variant="gradient" className="w-full font-bold"> Get Started</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="space-y-4 text-xs">
              <ul className="space-y-2">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Hạ tầng Private Server riêng</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Không giới hạn Sales Reps</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Tùy chỉnh AI Model & Custom SLA</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Hỗ trợ kỹ thuật 24/7 Dedicated Manager</li>
              </ul>
